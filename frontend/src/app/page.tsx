...
const tableHeaders = ["Data Variable", "Source Authority", "Impact on Tone Engine"];
    ...
    >
      ...
      >
        ...
        <Link href="/" className="flex items-center gap-3">
          <ToneLogo size={42} />
          <span className="text-[28px] font-bold text-[#1a1a1a] tracking-tight">Tone</span>
        </Link>
      ...
      <section id="benefits" className="px-8 md:px-16 lg:px-24 py-24 md:py-32">
        ...
        <ScrollFade delay={0.15}>
          <p className="text-[#6f6f6f] text-[15px] leading-relaxed max-w-2xl mb-20">
            ...
            Tone leads the charge to make real estate sustainable, mapping the intersection
            of high water costs, ESG mandates, and droplet recapture potential.
          </p>
        </ScrollFade>
        ...
        <ScrollFade>
          <div className="w-full rounded-2xl overflow-hidden bg-[#e8e3d8] relative" style={{ aspectRatio: "16/7" }}>
            <Image
              ...
              alt="Tone national data visualization"
              fill
              className="object-cover object-center"
              sizes="100vw"
            />
      ...
      <section id="data-source" className="px-8 py-24 md:px-16 md:py-32 lg:px-24">
        ...
        <ScrollFade delay={0.15}>
          <p className="mx-auto mb-16 max-w-4xl text-center text-[18px] leading-relaxed text-[#767676] md:text-[19px]">
            Every building surfaced by Tone is backed by multi-layered data — from satellite imagery to climate
            records and economic modeling — ensuring decisions you can trust.
          </p>
        </ScrollFade>
